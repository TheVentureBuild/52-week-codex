...
export default function KnowledgeCenterPage() {
  return (
    <AppShell>
      ...
      <Card className="mb-5"><div className="grid gap-3 md:grid-cols-[1fr_auto]"><Field label="Search documentation" value="Partner Score" /><Link href="/success/search?q=Partner%20Score"><Button><Search className="mr-2" size={16}/>Search</Button></Link></div></Card>
      <div className="grid gap-5 lg:grid-cols-[1fr_360px]">
        ...
        <div className="grid h-fit gap-5">
          ...
          <Link href="/success/ask"><Button className="w-full">Ask AI</Button></Link>
        </div>
      </div>
    </AppShell>
  );
